...
/// @notice Treasury minimal untuk menerima ETH dan memindahkan ETH / ERC20 token.
/// @dev Tidak memakai interface IERC20, tidak ada fungsi cek saldo. Transfer token dilakukan via low-level call.
